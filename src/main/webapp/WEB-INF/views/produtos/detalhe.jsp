...
<link href="<c:url value="/resources/css/cssbase-min.css" />" rel="stylesheet" />
<link href="<c:url value="/resources/css/prods.css" />" rel="stylesheet" />
...
<link href="<c:url value="/resources/css/fontello-embedded.css"/>" rel="stylesheet" />

<link href="<c:url value="/resources/css/fontello.css"/>" rel="stylesheet" />
<link href="<c:url value="/resources/css/style.css"/>" rel="stylesheet" />
<link href="<c:url value="/resources/css/layout-colors.css"/>" rel="stylesheet" />
<link href="<c:url value="/resources/css/responsive-style.css"/>" rel="stylesheet" />
<link href="<c:url value="/resources/css/guia-do-programador-style.css"/>" rel="stylesheet" />
